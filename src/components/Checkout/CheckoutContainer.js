...
<div className="input-name">
<textarea type="text" placeholder="Address    | Street name apartment, suite, floor" className="textarea" />
...
<div className="input-name">
    ...
    <label for="cb1" className="chack">I agree I am over 18 years old</label>
</div>


<div className="input-name">
    <input type="checkbox" id="cb2" className="chack-button" />
    <label for="cb2" className="chack">Save the Address</label>
</div>
    ...
    <div className="Products">
        {
            data.products.map(product => (
                ...
                <div className="productDetail">
                    <img src={product.image}className="productImage" alt="product image" />
               <h4>{product.name}</h4>
                </div>
