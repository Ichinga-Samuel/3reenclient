...
import { Dot, ProdInfo, ViewProdBtn } from './styles/CustomerProdInfoStyled';
import { CustomerViewProduct, ItemName, ItemPrice, ItemDetails } from './styles/ViewProductStyled';
