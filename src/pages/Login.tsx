         ...
         <div className='wrap'>
           <div id="form-section">
            <div id='form-cover'>
              ...
              <form action="POST">
                 <input type="text" name="Username" onChange={this.userInput} className='input L-input' id="username" placeholder="Username"/>
                 <input type="password" className='input  L-input' name="password" id="password" placeholder="Password"/>
                 <div className="align-submit">
                 <Link href="">
                   <a>forgot password?</a>
                 </Link>
                 <input type="submit" name='submit' onChange={this.passInput} id="submit" value="Log in"/>
                 </div>
              </form>
              <div id="social">
                <div>
